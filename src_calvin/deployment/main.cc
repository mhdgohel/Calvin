...
storage->Initmutex();
  ...
  fprintf(stderr, "Initializing Sequencer...\n");
  Sequencer sequencer(&config, multiplexer.NewConnection("sequencer"), multiplexer.NewConnection("sequencer_sync"), client,
                      storage);
  fprintf(stderr, "Sequencer initialized.\n");
